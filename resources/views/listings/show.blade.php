    ...
    @if($listing)
         <x-card class="p-10">
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <div>
                    <h3 class="text-3xl font-bold mb-4">INTERNSHIP DESCRIPTION</h3>
                    <div class="text-lg space-y-6">
                        ...
                        <a href="{{$listing->webiste}}" target="_blank" class="block bg-black text-white py-2 rounded-xl hover:opacity-80">
